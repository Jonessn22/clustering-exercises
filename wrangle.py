...
def acquire_data(file_name, db):
    '''
THIS FUNCTION TAKES IN A CSV FILE NAME AND A DB FROM THE SQL SERVER. IF THE FILE EXISTS
IN THE LOCAL DIRECTORY IT WILL WRITE IT TO A DF. IF IT DOES NOT IT WILL USE THE DB AND 
CONNECTION FUNCTION TO WRITE THE SQL QUERY TO A DB AND THEN WRITE THE QUERY TO A CSV TO
BE SAVED LOCALLY.
    '''
